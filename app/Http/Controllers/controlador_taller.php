...
class controlador_taller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return view('numeroprimo', compact('numero', 'esPrimo'));
    }
    ...
    //numerosamigos
    public function createAmigos()
    {
        return view('numeroamigo');
    }
    ...
    public function storeAmigos(Request $request)
    {
        ...
        return view('numeroamigo', compact('numero1', 'numero2', 'sonAmigos'));
    }
    ...
    public function storeNotas(Request $request)
    {
        ...
        return view('promedionotas', compact('nota1', 'nota2', 'nota3', 'promedio'));
    }
   ...
   public function createCuadratica()
    ...
    public function storeCuadratica(Request $request)
    {
        ...
        return view('formulacuadratica', compact('a', 'b', 'c', 'discriminante', 'raiz1', 'raiz2'));
    }
}
